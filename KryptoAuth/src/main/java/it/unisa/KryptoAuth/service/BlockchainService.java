...
public interface BlockchainService {
    ...
    /*================================== KryptoNFT contract =====================================*/
    boolean mintNft(String name, String category, String description, String url, BigInteger price, BigInteger validUntil, BigInteger sale) throws Exception;
    ...
    boolean burnNftExpired(BigInteger id) throws Exception;
